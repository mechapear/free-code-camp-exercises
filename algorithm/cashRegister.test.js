...
describe('checkCashRegister', () => {
  ...
  it('should return status Insufficient case 1', () => {
    const result = checkCashRegister(19.5, 20, [
      ['PENNY', 0.01],
      ['NICKEL', 0],
      ['DIME', 0],
  ...
  it('should return status Insufficient case 2', () => {
    const result = checkCashRegister(19.5, 20, [
      ['PENNY', 0.01],
      ['NICKEL', 0],
      ['DIME', 0],
  ...
  it('should return status Closed', () => {
    const result = checkCashRegister(19.5, 20, [
      ['PENNY', 0.5],
      ['NICKEL', 0],
      ['DIME', 0],
